...
\begin{frame}
  ...
  With this dictionary, \\
   ...
   Similarly, $T(1) = 2$, and $T(\inlinetangle{\tangleone}) = \inlinetangle{\tangletwo}$, \\
   and so \\
   \quad the role of ``two'' is played by $\inlinetangle{\tangletwo}$.
...
\begin{frame}
  ...
  \item By tricoloring, not every knot is the unknot.
